...
uniform	vec4	light_attenuation3;
uniform	vec4	derived_light_diffuse4;
uniform	vec4	derived_light_specular5;
...
void main(void) {
	...
	SGX_Light_Point_DiffuseSpecular(lLocalParam_2, oTexcoord3_1, oTexcoord3_3.xyz, light_attenuation3, derived_light_diffuse4.xyz, derived_light_specular5.xyz, surface_shininess, lNormalMapDiffuse.xyz, lNormalMapSpecular.xyz, lNormalMapDiffuse.xyz, lNormalMapSpecular.xyz);
