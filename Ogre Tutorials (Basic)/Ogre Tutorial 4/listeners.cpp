...
Listeners::Listeners (Ogre::Root*& root, Ogre::RenderWindow*& window, Ogre::SceneManager*& sceneMgr, Ogre::Camera*& camera, OgreBites::SdkCameraMan*& cameraMan) :
    mRoot         (root),
    mWindow       (window),
    mSceneMgr     (sceneMgr),
    mCamera       (camera),
...
bool Listeners::processUnbufferedInput (const Ogre::FrameEvent& evt)
{
